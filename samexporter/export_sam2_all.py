...
class SAM2FullModel(nn.Module):
    ...
    def forward(
        ...
        high_res_feats_0, high_res_feats_1, image_embed = self.encoder(image)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Export the SAM2 full model (encoder and decoder) to an ONNX model."
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
